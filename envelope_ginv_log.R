...
# do ajuste da regress?o com erros normal inversa e liga??o
# log.  Deixe tamb?m os dados dispon?veis atrav?s do
...
# o comando title("..."). Para  usar  outras  liga??es
# mudar no programa abaixo o termo family=inverse.gaussian
# (link=log)  por inverse.gaussian no caso de liga??o
# rec?proca ao quadrado  ou por family=inverse.gaussian
# (link=identidade) no caso de liga??o identidade.
#------------------------------------------------------------#
# Fun??o para gerar observa??es de uma distribui??o
# normal inversa
